...
def lazy_import():
    ...
    globals()['AutocompleteBudget'] = AutocompleteBudget


class AutocompleteBudgetArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AutocompleteBudgetArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AutocompleteBudget]):  # noqa: E501

        Keyword Args:
            value ([AutocompleteBudget]):  # noqa: E501
