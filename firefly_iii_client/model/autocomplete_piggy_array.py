...
def lazy_import():
    ...
    globals()['AutocompletePiggy'] = AutocompletePiggy


class AutocompletePiggyArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AutocompletePiggyArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AutocompletePiggy]):  # noqa: E501

        Keyword Args:
            value ([AutocompletePiggy]):  # noqa: E501
