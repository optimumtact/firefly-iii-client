...
class RuleActionStore(ModelNormal):
    ...
    def _from_openapi_data(cls, type, value, *args, **kwargs):  # noqa: E501
        """RuleActionStore - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            active (bool): If the action is active. Defaults to true.. [optional] if omitted the server will use the default value of True  # noqa: E501
            order (int): Order of the action. [optional]  # noqa: E501
            stop_processing (bool): When true, other actions will not be fired after this action has fired. Defaults to false.. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
