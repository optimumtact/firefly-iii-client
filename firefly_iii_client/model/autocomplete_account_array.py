...
def lazy_import():
    ...
    globals()['AutocompleteAccount'] = AutocompleteAccount


class AutocompleteAccountArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AutocompleteAccountArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AutocompleteAccount]):  # noqa: E501

        Keyword Args:
            value ([AutocompleteAccount]):  # noqa: E501
