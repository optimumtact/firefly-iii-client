...
class ConfigValueFilter(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'CONFIGURATION.PERMISSION_UPDATE_CHECK': "configuration.permission_update_check",
            'CONFIGURATION.LAST_UPDATE_CHECK': "configuration.last_update_check",
            'CONFIGURATION.SINGLE_USER_MODE': "configuration.single_user_mode",
    ...
    def __init__(self, *args, **kwargs):
        """ConfigValueFilter - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["configuration.is_demo_site", "configuration.permission_update_check", "configuration.last_update_check", "configuration.single_user_mode", "firefly.version", "firefly.api_version", "firefly.default_location", "firefly.account_to_transaction", "firefly.allowed_opposing_types", "firefly.accountRoles", "firefly.valid_liabilities", "firefly.interest_periods", "firefly.enable_external_map", "firefly.expected_source_types", "app.timezone", ]  # noqa: E501
