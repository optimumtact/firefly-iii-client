...
def lazy_import():
    ...
    globals()['AvailableBudget'] = AvailableBudget


class AvailableBudgetRead(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': (AvailableBudget,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, attributes, id, type, *args, **kwargs):  # noqa: E501
        """AvailableBudgetRead - a model defined in OpenAPI
