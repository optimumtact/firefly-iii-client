...
def lazy_import():
    ...
    globals()['AutocompleteBill'] = AutocompleteBill


class AutocompleteBillArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AutocompleteBillArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AutocompleteBill]):  # noqa: E501

        Keyword Args:
            value ([AutocompleteBill]):  # noqa: E501
