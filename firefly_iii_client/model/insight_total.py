...
def lazy_import():
    ...
    globals()['InsightTotalEntry'] = InsightTotalEntry


class InsightTotal(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """InsightTotal - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([InsightTotalEntry]):  # noqa: E501

        Keyword Args:
            value ([InsightTotalEntry]):  # noqa: E501
