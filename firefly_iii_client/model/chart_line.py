...
def lazy_import():
    ...
    globals()['ChartDataSet'] = ChartDataSet


class ChartLine(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ChartLine - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ChartDataSet]):  # noqa: E501

        Keyword Args:
            value ([ChartDataSet]):  # noqa: E501
