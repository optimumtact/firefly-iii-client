...
def lazy_import():
    ...
    globals()['PiggyBankEvent'] = PiggyBankEvent


class PiggyBankEventRead(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': (PiggyBankEvent,),  # noqa: E501
            'id': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, attributes, id, links, type, *args, **kwargs):  # noqa: E501
        """PiggyBankEventRead - a model defined in OpenAPI
