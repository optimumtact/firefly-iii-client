...
class RuleTriggerStore(ModelNormal):
    ...
    def _from_openapi_data(cls, type, value, *args, **kwargs):  # noqa: E501
        """RuleTriggerStore - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            active (bool): If the trigger is active. Defaults to true.. [optional] if omitted the server will use the default value of True  # noqa: E501
            order (int): Order of the trigger. [optional]  # noqa: E501
            stop_processing (bool): When true, other triggers will not be checked if this trigger was triggered. Defaults to false.. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
