...
def lazy_import():
    ...
    globals()['AutocompleteTag'] = AutocompleteTag


class AutocompleteTagArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AutocompleteTagArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AutocompleteTag]):  # noqa: E501

        Keyword Args:
            value ([AutocompleteTag]):  # noqa: E501
