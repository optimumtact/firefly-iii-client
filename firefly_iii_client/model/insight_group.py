...
def lazy_import():
    ...
    globals()['InsightGroupEntry'] = InsightGroupEntry


class InsightGroup(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """InsightGroup - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([InsightGroupEntry]):  # noqa: E501

        Keyword Args:
            value ([InsightGroupEntry]):  # noqa: E501
