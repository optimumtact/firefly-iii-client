...
def lazy_import():
    ...
    globals()['AutocompleteRule'] = AutocompleteRule


class AutocompleteRuleArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AutocompleteRuleArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AutocompleteRule]):  # noqa: E501

        Keyword Args:
            value ([AutocompleteRule]):  # noqa: E501
