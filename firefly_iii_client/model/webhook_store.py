...
def lazy_import():
    ...
    globals()['WebhookDelivery'] = WebhookDelivery
    globals()['WebhookResponse'] = WebhookResponse
    globals()['WebhookTrigger'] = WebhookTrigger


class WebhookStore(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'delivery': (WebhookDelivery,),  # noqa: E501
            'response': (WebhookResponse,),  # noqa: E501
            'title': (str,),  # noqa: E501
            'trigger': (WebhookTrigger,),  # noqa: E501
            'url': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, delivery, response, title, trigger, url, *args, **kwargs):  # noqa: E501
        """WebhookStore - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, delivery, response, title, trigger, url, *args, **kwargs):  # noqa: E501
        """WebhookStore - a model defined in OpenAPI
