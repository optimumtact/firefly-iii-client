...
def lazy_import():
    ...
    globals()['InsightTransferEntry'] = InsightTransferEntry


class InsightTransfer(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """InsightTransfer - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([InsightTransferEntry]):  # noqa: E501

        Keyword Args:
            value ([InsightTransferEntry]):  # noqa: E501
