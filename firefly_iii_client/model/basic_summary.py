...
def lazy_import():
    ...
    globals()['BasicSummaryEntry'] = BasicSummaryEntry


class BasicSummary(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """BasicSummary - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([BasicSummaryEntry]):  # noqa: E501

        Keyword Args:
            value ([BasicSummaryEntry]):  # noqa: E501
