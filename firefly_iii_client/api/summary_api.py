...
class SummaryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_basic_summary_endpoint = _Endpoint(
            settings={
                'response_type': (BasicSummary,),
                'auth': [
                    'firefly_iii_auth'
                ],
                'endpoint_path': '/api/v1/summary/basic',
                'operation_id': 'get_basic_summary',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_basic_summary(
        ...
        **kwargs
        ...
        Returns basic sums of the users data, like the net worth, spent and earned amounts. It is multi-currency, and is used in Firefly III to populate the dashboard.   # noqa: E501
        ...
        return self.get_basic_summary_endpoint.call_with_http_info(**kwargs)
