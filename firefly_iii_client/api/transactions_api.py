...
class TransactionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_transaction_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/transactions/{id}',
        ...
        self.delete_transaction_journal_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'firefly_iii_auth'
                ],
                'endpoint_path': '/api/v1/transaction-journals/{id}',
                'operation_id': 'delete_transaction_journal',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_transaction_endpoint = _Endpoint(
            settings={
                'response_type': (TransactionSingle,),
                'auth': [
                    'firefly_iii_auth'
                ],
                'endpoint_path': '/api/v1/transactions/{id}',
        ...
        self.get_transaction_by_journal_endpoint = _Endpoint(
            settings={
                'response_type': (TransactionSingle,),
                'auth': [
                    'firefly_iii_auth'
                ...
                'endpoint_path': '/api/v1/transaction-journals/{id}',
                'operation_id': 'get_transaction_by_journal',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_attachment_by_transaction_endpoint = _Endpoint(
            settings={
                'response_type': (AttachmentArray,),
                'auth': [
                    'firefly_iii_auth'
                ],
                'endpoint_path': '/api/v1/transactions/{id}/attachments',
                'operation_id': 'list_attachment_by_transaction',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_event_by_transaction_endpoint = _Endpoint(
            settings={
                'response_type': (PiggyBankEventArray,),
                'auth': [
                    'firefly_iii_auth'
                ],
                'endpoint_path': '/api/v1/transactions/{id}/piggy_bank_events',
                'operation_id': 'list_event_by_transaction',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_links_by_journal_endpoint = _Endpoint(
            settings={
                'response_type': (TransactionLinkArray,),
                'auth': [
                    'firefly_iii_auth'
                ],
                'endpoint_path': '/api/v1/transaction-journals/{id}/links',
                'operation_id': 'list_links_by_journal',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_transaction_endpoint = _Endpoint(
            settings={
        ...
        self.store_transaction_endpoint = _Endpoint(
            settings={
                'response_type': (TransactionSingle,),
                'auth': [
                    'firefly_iii_auth'
                ...
                'endpoint_path': '/api/v1/transactions',
                'operation_id': 'store_transaction',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def delete_transaction_journal(
        ...
        **kwargs
        ...
        """Delete split from transaction  # noqa: E501

        Delete an individual journal (split) from a transaction.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_transaction_journal(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.delete_transaction_journal_endpoint.call_with_http_info(**kwargs)
    ...
    def get_transaction_by_journal(
        ...
        **kwargs
        ...
        """Get a single transaction, based on one of the underlying transaction journals (transaction splits).  # noqa: E501

        Get a single transaction by underlying journal (split).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['id'] = \
            id
        return self.get_transaction_by_journal_endpoint.call_with_http_info(**kwargs)
    ...
    def list_attachment_by_transaction(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.list_attachment_by_transaction_endpoint.call_with_http_info(**kwargs)
    ...
    def list_event_by_transaction(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.list_event_by_transaction_endpoint.call_with_http_info(**kwargs)
    ...
    def list_links_by_journal(
        ...
        **kwargs
        ...
        """Lists all the transaction links for an individual journal (individual split).  # noqa: E501

        Lists all the transaction links for an individual journal (a split). Don't use the group ID, you need the actual underlying journal (the split).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_links_by_journal(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.list_links_by_journal_endpoint.call_with_http_info(**kwargs)
    ...
    def list_transaction(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_transaction_endpoint.call_with_http_info(**kwargs)
    ...
    def store_transaction(
        ...
        **kwargs
        ...
        >>> thread = api.store_transaction(transaction_store, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['transaction_store'] = \
            transaction_store
        return self.store_transaction_endpoint.call_with_http_info(**kwargs)
